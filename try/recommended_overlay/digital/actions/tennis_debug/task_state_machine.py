...
ALLOWED_TRANSITIONS = {
    ...
    SortingState.ALIGN: {
        SortingState.APPROACH, SortingState.RECORD, SortingState.SAFE_STOP,
    },
    SortingState.APPROACH: {SortingState.GRASP, SortingState.SAFE_STOP},
    SortingState.GRASP: {
    ...
    SortingState.RETURN_HOME: {SortingState.RECORD, SortingState.SAFE_STOP},
    SortingState.RECORD: {
