...
class GraspBottleTennisAction(GraspCubeAction):
    ...
    def __init__(self):
        ...
        self.declare_parameter("placement_distance_m", 0.650)
        self.declare_parameter("placement_distance_decrement_m", 0.070)
        self.declare_parameter("placement_minimum_distance_m", 0.300)
