...
def first_available_package(*names):
    for name in names:
        try:
            ...
            continue
    raise RuntimeError(
        "No ROS-Gazebo spawn package is installed; install "
        "ros-humble-ros-gz-sim (or ros-humble-ros-ign-gazebo)."
    )
...
def generate_launch_description():
    ...
    world = os.path.join(pkg, "worlds", "pick_place_tennis_debug.sdf")
    ...
    create_package = first_available_package("ros_gz_sim", "ros_ign_gazebo")
    gazebo_environment = {
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description="Run the Gazebo server without Qt GUI",
        ),
